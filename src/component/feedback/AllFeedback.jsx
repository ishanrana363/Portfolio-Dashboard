...
const AllFeedback = () => {
    ...
    const {totalFeedbackDataApi,totalFeedbackDataList,totalFeedbackLength} = feedbackStore();
    ...
    useEffect(() => {
        (async () => {
            setLoader(true);
            await totalFeedbackDataApi(1, perPage, 0);
            setLoader(false);
        })();
    }, [id]);
    ...
    const handlePageChange = async (event) => {
        ...
        setLoader(true);
        await totalFeedbackDataApi(pageNo + 1, perPage, searchValue);
        setLoader(false);
    };
    ...
    const getPerPageData = async (event) => {
        ...
        setLoader(true);
        await totalFeedbackDataApi(1, newPerPage, 0);
        setLoader(false);
    };
    ...
    const submitSearchValue = async () => {
        setLoader(true);
        await totalFeedbackDataApi(1, perPage, searchValue);
        setLoader(false);
    };
            ...
            <div className="p-4">
                ...
                <div className="overflow-x-auto">
                    <table className="min-w-full bg-white border border-gray-300 rounded-lg shadow-lg">
                        ...
                        <tbody>
                            {
                                totalFeedbackDataList && totalFeedbackDataList.map((item, i) => (
                ...
                <div className="mt-5">
                    <nav aria-label="Page navigation example">
                        <ReactPaginate
                            previousLabel="prev"
                            nextLabel="next"
                            pageCount={Math.ceil(totalFeedbackLength / perPage)}
